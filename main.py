...
print( "The accurancy with the testing data set of the Desicion Tree is:"+ str(test_acc))
...
print( "The accurancy with the training data set of the Desicion Tree is:"+ str(train_acc))
...
print("\n A Decision Tree would be helpful to predict whether a vehicle is likely to fail or need major repairs based on measurements and history. Some factors to be careful of are making sure the data set includes data from a wide variety of different models and types of cars, selecting only the measurements that are relevant so the model does not introduce bias, and balanced data is necesary to make sure the dataset isn't overload with only 'problem' cars.\n")
